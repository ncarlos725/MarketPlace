...
namespace MarketPlacedouh.Controllers
{
    ...
    public class ClienteController : ControllerBase
    {
        ...
        public dynamic eliminarCliente(Cliente cliente)
        {
            ...
            var rtoken = Jtw.validarToken(identity); // escribi mal la clase Jwt... y le mande Jtw... 
            if (!rtoken.success)
                return rtoken;// en caso el token.succes es igual a false va retonar lo que diga aqui el token
